   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Variables are not the same type and values\n"
     ]
    }
   ],
   "source": [
    ...
    "y='1'\n",
    "if x==y:\n",
    "    print(\"Variables the same type and values\")\n",
    "else:\n",
    "    print(\"Variables are not the same type and values\")"
   ]
  },
  {
   "cell_type": "raw",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Variables the same type and values\n"
     ]
    }
   ],
   "source": [
